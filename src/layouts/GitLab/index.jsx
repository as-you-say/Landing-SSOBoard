  ...
  return (
    <div id="github" className="clear">
      ...
      <KanbanBoard
        ...
        dataList={selectedRepository.mergeRequests}
      />
    </div>
  )
}
...
const data =[
  ...
  ,
  {
    ...
    mergeRequests:[
      { id:"0", name:"Merge Request-1- Hey! completed!", link:"https://github.com"},
      { id:"1", name:"Merge Request-2- Hey! completed!", link:"https://github.com"},
      { id:"2", name:"Merge Request-3- Hey! completed!", link:"https://github.com"},
      { id:"3", name:"Merge Request-4- Hey! completed!", link:"https://github.com"},
    ]
  }
]